...
{
    my $date1 = DateTimeX::Lite->new( year => 2001, month => 5, day => 10,
			       hour => 4, minute => 3, second => 2,
			       nanosecond => 12,
			       time_zone => 'UTC' );

    my $date2 = DateTimeX::Lite->new( year => 2001, month => 6, day => 12,
...
{
    my $d = DateTimeX::Lite->new( year => 2001, month => 10, day => 19,
...
{
    my $dt1 = DateTimeX::Lite->new( year => 2003, month => 2, day => 9,
                             hour => 0, minute => 0, second => 1,
                             time_zone => 'UTC',
                           );

    my $dt2 = DateTimeX::Lite->new( year => 2003, month => 2, day => 7,
    ...
    is( DateTimeX::Lite->compare($dt1, $dt3), 0,
...
{
    my $dt1 = DateTimeX::Lite->new( year => 2000, month => 1, day => 5,
                             hour => 0, minute => 10, second => 0,
                             nanosecond => 1,
                             time_zone => 'UTC',
                           );

    my $dt2 = DateTimeX::Lite->new( year => 2000, month => 1, day => 6,
                             hour => 0, minute => 10, second => 0,
                             nanosecond => 0,
                             time_zone => 'UTC',
                           );
...

{
    ...
    my $dt2 = DateTimeX::Lite->new( year => 2000, month => 1, day => 5,
                             hour => 0, minute => 10, second => 0,
                             nanosecond => 10,
                             time_zone => 'UTC',
                           );
...
{
    my $dt1 = DateTimeX::Lite->new( year => 2003, month => 12, day => 31 );
...
{
    my $date1  = DateTimeX::Lite->new( year => 2003, month =>  9, day => 30 );
    my $date2  = DateTimeX::Lite->new( year => 2003, month => 10, day =>  1 );

    my $date3  = DateTimeX::Lite->new( year => 2003, month => 10, day => 31 );
    my $date4  = DateTimeX::Lite->new( year => 2003, month => 11, day =>  1 );

    my $date5  = DateTimeX::Lite->new( year => 2003, month => 2, day => 28 );
    my $date6  = DateTimeX::Lite->new( year => 2003, month => 3, day =>  1 );

    my $date7 = DateTimeX::Lite->new( year => 2003, month => 1, day => 31 );
    my $date8 = DateTimeX::Lite->new( year => 2003, month => 2, day =>  1 );
...
{
    my $dt1 = DateTimeX::Lite->new( year => 2005, month => 6, day => 11,
                             time_zone => 'UTC',
                           );

    my $dt2 = DateTimeX::Lite->new( year => 2005, month => 11, day => 10,
                             time_zone => 'UTC',
                           );
